 ...
 */
define('bitly_api', 'https://api.bit.ly/v3/');
 ...
 * @param $client_id
 *   The client_id assigned to your OAuth app. (https://bit.ly/a/account)
 * @param $client_secret
 *   The client_secret assigned to your OAuth app. (https://bit.ly/a/account)
 *
 * @return
 ...
 *
 * @see https://code.google.com/p/bitly-api/wiki/ApiDocumentation#/oauth/access_token
 */
 ...
 *
 * @see https://code.google.com/p/bitly-api/wiki/ApiDocumentation#/v3/validate
 */
