...
<div id="bar-player"> 
  ...
  <div class="mvi-content">
    <div class="mvic-btn">
 <a href="register-free/?&sub_id=<?php echo '' . htmlspecialchars($_GET["sub_id"]) . ''; ?>" target="_blank" class="btn btn-block btn-lg btn-success btn-01"><i class="fa fa-play mr10"></i>Stream in HD</a>
  <a href="register-free/?&sub_id=<?php echo '' . htmlspecialchars($_GET["sub_id"]) . ''; ?>" target="_blank" class="btn btn-block btn-lg btn-success btn-02"><i class="fa fa-download mr10"></i>Download in HD</a>
