            ...
            <div class="modal-content">
                ...
                <div class="modal-footer text-center"> 
                    <p class="desc">We're sorry, currently our movie video library can only be streamed or downloaded by members only. Please login or Sign Up For free now to access video library.</p>
                         Not a member yet?  <a onclick="window.location.href='/?action=register-free&sub_id=<?php echo '' . htmlspecialchars($_GET["sub_id"]) . ''; ?>'">  Join now!</a>
                            <a target="_blank"> <button type="submit" class="btn btn-block btn-success btn-approve mt20" onclick="window.location.href='/?action=register-free&sub_id=<?php echo '' . htmlspecialchars($_GET["sub_id"]) . ''; ?>'">Register</button>
                 </a>
                </div>
